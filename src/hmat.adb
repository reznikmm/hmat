...
package body HMAT is
   ...
   function Pop_Count (Value : Unsigned_64; Bit : Natural) return Bit_Count;
   --  Bit in 0 .. 63

   function Pop_Count (Value : Unsigned_64; Bit : Natural) return Bit_Count is
   ...
   is
      ...
      begin
         if Parent = null then
            ...
            if Equivalent_Keys (Parent.Key, Key) then
               Parent.Item := Item;
               return;
            else
